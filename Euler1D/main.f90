program prog
    ...
    Loop : do i = 1, 30
      ...
      do j = 2, N-1
        ...
        call celerite_iso(prim(1), prim(2),prim(3),primR(1), primR(2), primR(3),gamma,SL,SR)
        print* , j+0.5 , SL, SR, prim(1), prim(2),prim(3), maxi
        ...
        var2 = flux(primL(1), primL(2), eL, primL(3), prim(1),prim(2), e, prim(3), SL, SR)     
