module mod_CI
  ...
  use mod_constante
  implicit none
  real :: xmin = 0, xmax = 1., ymin = 0, ymax = 1., x0, x1, y0
  ...
  subroutine Cas_test(n)
    ...
    if (n==-4) then
      ! Sod test pour validation : direction Y
      ! Droite 
      p2 = 0.1; rho2 = 0.125; v2 = 0.; u2 = 0.
      p1 = 0.1; rho1 = 0.125 ; v1 = 0.; u1 = 0.; 
      ! Gauche 
      p4 = 1.; rho4 = 1.; v4 = 0.75; u4 = 0;
      p3 = 1.; rho3 = 1.; v3 = 0.75; u3 =  0.;
      tout = 0.20
      x0 = 0.3
      y0 = 0.3
    ...
    if (n==-3) then
      ! Sod test pour validation : direction X
      ! Droite 
      p4 = 0.1; rho4 = 0.125; v4 = 0.; u4 = 0.
      p1 = 0.1; rho1 = 0.125 ; v1 = 0.; u1 = 0.; 
      ! Gauche 
      p2 = 1.; rho2 = 1.; v2 = 0; u2 = 0.75;
      p3 = 1.; rho3 = 1.; v3 = 0.; u3 =  0.75;
      tout = 0.2
      x0 = 0.3
      y0 = 0.5
    end if
    ...
    if (n==-2) then
      ...
      ! Droite 
      p2 = 0.01; rho2 = 1.; v2 = -19.59725; u2 = 0.
      p1 = 0.01; rho1 = 1. ; v1 = -19.59745; u1 = 0.; 
      ! Gauche 
      p4 = 1000.; rho4 = 1.; v4 = -19.59745; u4 = 0.0;
      p3 = 1000.; rho3 = 1.; v3 = -19.59745; u3 =  0.;
      tout = 0.012
      x0 = 0.5
      y0 = 0.8
    end if
    ...
    if (n==-1) then
      ...
      ! Droite 
      p4 = 0.01; rho4 = 1.; u4 = -19.59725; v4 = 0.
      p1 = 0.01; rho1 = 1. ; u1 = -19.59745; v1 = 0.; 
      ! Gauche 
      p2 = 1000.; rho2 = 1.; u2 = -19.59745; v2 = 0.0;
      p3 = 1000.; rho3 = 1.; u3 = -19.59745; v3 =  0.;
      tout = 0.012
      x0 = 0.8
      y0 = 0.5
    end if
